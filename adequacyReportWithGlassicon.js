...
export default class adeqacyReportWithGlassicon extends LightningElement {
    ...
    submit(){
      ...
      /*  if(this.fromdate == null & this.todate == null){
        ...
        keyaccount({recordtype:this.recordtype, acctype: this.accounttype, sales:this.sales,accprogram:this.accprogram,fdate:this.fromdate,tdate:this.todate, oppStage:this.oppStage, oppregion: this.oppregion ,glassIcon: this.glassIcon})
        .then(result=>{
